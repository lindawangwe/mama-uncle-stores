	...
	return (
		<div className='min-h-screen flex items-center justify-center px-4'>
			<motion.div
				...
				className='max-w-md w-full bg-teal-900 rounded-lg shadow-xl overflow-hidden relative z-10'
			>
				<div className='p-6 sm:p-8'>
					...
					<div className='space-y-4'>
						<Link
							to={"/"}
							className='w-full bg-teal-900 hover:bg-teal-600 text-amber-200 font-bold py-2 px-4 rounded-lg transition 
